...
const (
	Student_SendStudent_FullMethodName = "/student.Student/SendStudent"
)
...
func (c *studentClient) SendStudent(ctx context.Context, in *StudentRequest, opts ...grpc.CallOption) (*StudentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StudentResponse)
	err := c.cc.Invoke(ctx, Student_SendStudent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStudentServer) SendStudent(context.Context, *StudentRequest) (*StudentResponse, error) {
...
func _Student_SendStudent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StudentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StudentServer).SendStudent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Student_SendStudent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StudentServer).SendStudent(ctx, req.(*StudentRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Student_SendStudent_Handler,
		},
	},
